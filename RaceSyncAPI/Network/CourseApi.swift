...
public protocol CourseApiInterface {
    ...
    /**
     */
    func createCourse(forChapter chapterId: ObjectId, with parameters: Params, _ completion: @escaping ObjectCompletionBlock<Course>)
...
public class CourseApi: CourseApiInterface {
    ...
    public func getCourse(with courseId: ObjectId, _ completion: @escaping ObjectCompletionBlock<Course>) {
        ...
        let params: Params = [ParamKey.id: courseId]
    ...
    public func createCourse(forChapter chapterId: ObjectId, with parameters: Params, _ completion: @escaping ObjectCompletionBlock<Course>) {
