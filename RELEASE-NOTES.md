...
- Added the 2023 GQ track design
- Added the 2023 Canadian Series track design
- Adding ZippyQ link, if applicable, on Race details

### Fixes and enhancements:

- Fixing LiveFPV broken link
- Limit race duplicating to regular races only (exclude GQ & child races)
- Sorting GQ races by upcoming
- Show upcoming races when filtered by class/spec
- Fixed event dates and times being displayed wrongly at times
